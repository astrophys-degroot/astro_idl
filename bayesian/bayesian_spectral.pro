...
;========================================================================================================================
pro bayesian_spectral, xs, ys, yerr, FEATURES=features, BORDER=border, FITVALS=fitvals, $ 
...
;       order polynomial fit to the continuum.  
;
;
; CALLING SEQUENCE:
;       
...
;           -based on baeysian_gauss3_lincont.pro 
;
;
; DESIRED UPGRADES
...
;       Efficiency
;         -check priors before likelihood calc
;         -only reevaluate cont or lines depending on jump
;         
;-
  ...
  IF keyword_set(STEPITER) THEN stepiter = stepiter[0] ELSE stepiter = 15              ;sets new value
