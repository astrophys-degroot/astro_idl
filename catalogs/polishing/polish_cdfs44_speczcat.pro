;========================================================================================================================
PRO polish_cdfs44_speczcat, FILE1=file1, FILE2=file2, FILE3=file3, FILE4=file4, $
...
;-
  ...
  ;;;default values
  IF keyword_set(FILE1) THEN file1 = file1[0] ELSE file1 = 'file1.fits'
  IF keyword_set(INDIR1) THEN indir1 = indir1[0] ELSE indir1 = ' '
  IF keyword_set(PRE1) THEN pre1 = pre1[0] ELSE pre1 = 'f1_'
  IF keyword_set(FILE2) THEN file2 = file2[0] ELSE file2 = 'file2.fits'
  IF keyword_set(INDIR2) THEN indir2 = indir2[0] ELSE indir2 = ' '
  IF keyword_set(PRE2) THEN pre2 = pre2[0] ELSE pre2 = 'f2_'
  IF keyword_set(FILE3) THEN file3 = file3[0] ELSE file3 = 'file3.fits'
  IF keyword_set(INDIR3) THEN indir3 = indir3[0] ELSE indir3 = ' '
  IF keyword_set(PRE3) THEN pre3 = pre3[0] ELSE pre3 = 'f3_'
  IF keyword_set(FILE4) THEN file4 = file4[0] ELSE file4 = 'file4.fits'
  IF keyword_set(INDIR4) THEN indir4 = indir4[0] ELSE indir4 = ' '
  IF keyword_set(PRE4) THEN pre4 = pre4[0] ELSE pre4 = 'f4_'
  IF keyword_set(OUTFILE) THEN outfile = outfile[0] ELSE outfile = 'composite_specz.fits'
  IF keyword_set(OUTDIR) THEN outdir = outdir[0] ELSE outdir = ' '
  ...
  chk = where(((outstruc.m_z NE -99.) OR (outstruc.m_rah NE -99.)) AND (outstruc.g_z_fors2 EQ -99.) AND (outstruc.j_specz EQ -99.) AND $
              (outstruc.p_z EQ -99.) AND (outstruc.speczbest EQ -99.))
  ...
  chk = where((outstruc.m_z EQ -99.) AND ((outstruc.g_z_fors2 NE -99.) OR (outstruc.g_ra NE -99.)) AND (outstruc.j_specz EQ -99.) AND $
              (outstruc.p_z EQ -99.) AND (outstruc.speczbest EQ -99.))
  IF chk[0] NE -1 THEN BEGIN
  ...
  chk = where((outstruc.m_z EQ -99.) AND (outstruc.g_z_fors2 EQ -99.) AND ((outstruc.j_specz NE -99.) OR (outstruc.j_ra NE -99.)) AND $
              (outstruc.p_z EQ -99.) AND (outstruc.speczbest EQ -99.))
  IF chk[0] NE -1 THEN BEGIN
  ...
  chk = where((outstruc.m_z EQ -99.) AND (outstruc.g_z_fors2 EQ -99.) AND (outstruc.j_specz EQ -99.) AND $
              ((outstruc.p_z NE -99.) OR (outstruc.p_ra NE -99.)) AND (outstruc.speczbest EQ -99.))
  IF chk[0] NE -1 THEN BEGIN
  ...
  chk = where(((outstruc.m_z NE -99.) OR (outstruc.m_rah NE -99.)) AND (outstruc.g_z_fors2 NE -99.) AND (outstruc.j_specz EQ -99.) AND $ ;
               (outstruc.p_z EQ -99.) AND (outstruc.speczbest EQ -99.))                                                                 ;mosfire and gillians FORS2
  IF chk[0] NE -1 THEN BEGIN
