;========================================================================================================================
PRO polish_xmm105_speczcat, FILE1=file1, FILE2=file2, FILE3=file3, FILE4=file4, $
...
;-
  ...
  ;;;default values
  IF keyword_set(FILE1) THEN file1 = file1[0] ELSE file1 = 'xmm105_mosfire_specz_v2-0.fits'
  ...
  IF keyword_set(OUTFILE) THEN outfile = outfile[0] ELSE outfile = 'xmm105_composite_specz_v2-0.fits'
