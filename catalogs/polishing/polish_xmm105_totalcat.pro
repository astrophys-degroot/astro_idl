;========================================================================================================================
PRO polish_xmm105_totalcat, FILE1=file1, FILE2=file2, $
                            PRE1=pre1, PRE2=pre2, $
...
;-
  ...
  ;;;default values
  IF keyword_set(FILE1) THEN file1 = file1[0] ELSE file1 = 'xmm105_composite_specz_v2-0.fits'
  ...
  IF keyword_set(FILE2) THEN file2 = file2[0] ELSE file2 = 'xmm105_v1_master.fits'
  IF keyword_set(INDIR2) THEN indir2 = indir2[0] ELSE indir2 = '/Users/adegroot/research/clusters/xmm/xmm105/catalogs/julie/xmm105_catalog_v1/'
  IF keyword_set(PRE2) THEN pre2 = pre2[0] ELSE pre2 = 'ph_'
  IF keyword_set(OUTFILE) THEN outfile = outfile[0] ELSE outfile = 'xmm105_pz_specz_full_v2-0-0.fits'
