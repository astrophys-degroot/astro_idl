pro clusterthumbnails_CDFS_I1I2
...
clustercat = '/chooyu1/muzzin/SpARCS/CDFS/foundclusters_I1I2/final_CDFS_fields.cat'
...
dir_z = '/chooyu1/muzzin/CTIO_data/CDFS_photometry/thumbnails_wide_I1I2/'
dir_irac1 = '/chooyu1/muzzin/SpARCS/CDFS/IRAC/thumbnails_wide_I1I2/'

;dir_z = '/chooyu1/muzzin/CTIO_data/CDFS_photometry/thumbnails_I1I2/'
;dir_irac1 = '/chooyu1/muzzin/SpARCS/CDFS/IRAC/thumbnails_I1I2/'
...
clustercmds_IRAC_CDFS_I1I2, cnum
...
write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/CDFS/clusterpics_I1I2/cluster'+string(cnum)+'.jpg', /remove_all), TVRD(true = 3), true = 3
...
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/CDFS/clusterpics/newcmr_cluster'+string(cnum)+'_wide.jpg', /remove_all), TVRD(true = 3), true = 3
