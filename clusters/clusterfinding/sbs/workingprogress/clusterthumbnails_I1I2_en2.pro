pro clusterthumbnails_ELAIS_I1I2
...
;for l = starter, starter do begin

for l = starter, 50 do begin
...
clustercat = '/chooyu1/muzzin/SpARCS/ELAIS-N2/foundclusters_I1I2/final_ELAISN2_fields.cat'
...
;dir_z = '/chooyu1/muzzin/SpARCS/ELAIS-N2/z/thumbnails_wide_I1I2/'
;dir_irac1 = '/chooyu1/muzzin/SpARCS/ELAIS-N2/IRAC/thumbnails_wide_I1I2/'

dir_z = '/chooyu1/muzzin/SpARCS/ELAIS-N2/z/thumbnails_I1I2/'
dir_irac1 = '/chooyu1/muzzin/SpARCS/ELAIS-N2/IRAC/thumbnails_I1I2/'
...
read_ELAISN2_zIRAC_finalcat, rra, rdec, apmag_176, eapmag_176, apmag_366, eapmag_366, mag_best, emag_best, c1_bf, c1_ebf, c1_3pxapc, c1_3pxerr, c2_bf, c2_ebf, c2_3pxapc, c2_3pxerr
...
clustercmds_IRAC_EN2_I1I2, cnum
...
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/clusterpics/cluster'+string(cnum)+'.jpg', /remove_all), TVRD(true = 3), true = 3
write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/clusterpics_I1I2/cluster'+string(cnum)+'_wide.jpg', /remove_all), TVRD(true = 3), true = 3
