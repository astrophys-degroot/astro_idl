pro clusterthumbnails_ELAISS1_I1I2
...
clustercat = '/chooyu1/muzzin/SpARCS/ELAIS-S1/foundclusters_I1I2/final_ELAISS1_fields.cat'
...
dir_z = '/chooyu1/muzzin/CTIO_data/ELAIS-S1_photometry/thumbnails_wide_I1I2/'
dir_irac1 = '/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/thumbnails_wide_I1I2/'

;dir_z = '/chooyu1/muzzin/CTIO_data/ELAIS-S1_photometry/thumbnails_I1I2/'
;dir_irac1 = '/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/thumbnails_I1I2/'
...
if l eq starter then window, 1, xsize = imagesize2*2.0 + 20.0, ysize = 2.0*imagesize2+40.0, title = 'Cluster: ' + strcompress(string(cnum),/remove_all) + '   RA: ' + string(sra[cnum]) + '   Dec: ' + string(sdec[cnum]) + '   z = ' + strcompress(string(z[cnum]),/remove_all); + '  KPNO field: ' + strcompress(string(KPNOfield[cnum]), /remove_all)
...
clustercmds_IRAC_ELAISS1_I1I2, cnum
...
write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/clusterpics_I1I2/cluster'+string(cnum)+'.jpg', /remove_all), TVRD(true = 3), true = 3
...
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/clusterpics/newcmr_cluster'+string(cnum)+'_wide.jpg', /remove_all), TVRD(true = 3), true = 3
