pro clusterthumbnails_CDFS

;Pick a cluster 

;250 clusters
inn = 231
for l = 0, 249 do begin
...
clustercat = '/chooyu1/muzzin/SpARCS/CDFS/foundclusters_z/final_CDFS_fields.cat'
...
dir_z = '/chooyu1/muzzin/CTIO_data/CDFS_photometry/thumbnails_wide/'
dir_irac1 = '/chooyu1/muzzin/SpARCS/CDFS/IRAC/thumbnails_wide/'

;dir_z = '/chooyu1/muzzin/CTIO_data/CDFS_photometry/thumbnails/'
;dir_irac1 = '/chooyu1/muzzin/SpARCS/CDFS/IRAC/thumbnails/'
...
read_CDFS_zIRAC_finalcat, rra, rdec, apmag_176, eapmag_176, apmag_366, eapmag_366, mag_best, emag_best, c1_bf, c1_ebf, c1_3pxapc, c1_3pxerr, c2_bf, c2_ebf, c2_3pxapc, c2_3pxerr
...
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/CDFS/clusterpics/cluster'+string(cnum)+'.jpg', /remove_all), TVRD(true = 3), true = 3
write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/CDFS/clusterpics/cluster'+string(cnum)+'_wide.jpg', /remove_all), TVRD(true = 3), true = 3
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/CDFS/clusterpics/cluster'+string(cnum)+'_wide_250kpcCMR.jpg', /remove_all), TVRD(true = 3), true = 3
