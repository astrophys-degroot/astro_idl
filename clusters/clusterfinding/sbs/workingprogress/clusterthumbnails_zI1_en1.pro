...
clustercat = '/chooyu1/muzzin/SpARCS/ELAIS-N1/foundclusters_z/final_ELAISN1_fields.cat'
...
dir_z = '/chooyu1/muzzin/SpARCS/ELAIS-N1/z/thumbnails_wide/'
dir_irac1 = '/chooyu1/muzzin/SpARCS/ELAIS-N1/IRAC/thumbnails_wide/'

;dir_z = '/chooyu1/muzzin/SpARCS/ELAIS-N1/z/thumbnails/'
;dir_irac1 = '/chooyu1/muzzin/SpARCS/ELAIS-N1/IRAC/thumbnails/'
...
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/clusterpics/cluster'+string(cnum)+'.jpg', /remove_all), TVRD(true = 3), true = 3

write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/clusterpics/cluster'+string(cnum)+'_wide.jpg', /remove_all), TVRD(true = 3), true = 3
