pro clusterthumbnails_ELAIS

;Pick a cluster 

;433 clusters
inn = 420
for l = inn, 433 do begin
...
clustercat = '/chooyu1/muzzin/SpARCS/ELAIS-S1/foundclusters_z/final_ELAISS1_fields.cat'
...
dir_z = '/chooyu1/muzzin/CTIO_data/ELAIS-S1_photometry/thumbnails_wide/'
dir_irac1 = '/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/thumbnails_wide/'

;dir_z = '/chooyu1/muzzin/CTIO_data/ELAIS-S1_photometry/thumbnails/'
;dir_irac1 = '/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/thumbnails/'

;imagebase_z = strcompress('/data1/muzzin/CFHTLS-XMM/z/'+dir+'/')
;imagebase_i = strcompress('/data1/muzzin/CFHTLS-XMM/i/'+dir+'/')
;image = strmid( strcompress(chip[cnum], /remove_all), 0, 11) + '_' + strmid(strcompress(chip[cnum], /remove_all), 11, strlen( strcompress(chip[cnum], /remove_all))-11)
;image1 = strcompress(image+'.fits', /remove_all)
...
read_ELAISS1_zIRAC_finalcat, rra, rdec, apmag_176, eapmag_176, apmag_366, eapmag_366, mag_best, emag_best, c1_bf, c1_ebf, c1_3pxapc, c1_3pxerr, c2_bf, c2_ebf, c2_3pxapc, c2_3pxerr
...
;blank_field_cmds, cnum
;clustercmds_IRAC_ES1, cnum

clustercmds_ES1, cnum
;clustercmds_i, cnum
...
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/clusterpics/cluster'+string(cnum)+'.jpg', /remove_all), TVRD(true = 3), true = 3
write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/clusterpics/cluster'+string(cnum)+'_wide.jpg', /remove_all), TVRD(true = 3), true = 3
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/clusterpics/cluster'+string(cnum)+'_wide_250kpcCMR.jpg', /remove_all), TVRD(true = 3), true = 3
