pro clusterthumbnails_LOCKMAN

;Pick a cluster 

gee = 354
;for l = 0, 578 do begin
for l = gee, gee do begin
...
clustercat = '/chooyu1/muzzin/SpARCS/Lockman/foundclusters_z/final_LOCKMAN_fields.cat'
...
dir_z = '/chooyu1/muzzin/SpARCS/Lockman/z/thumbnails_wide/'
dir_irac1 = '/chooyu1/muzzin/SpARCS/Lockman/IRAC/thumbnails_wide/'

;dir_z = '/chooyu1/muzzin/SpARCS/Lockman/z/thumbnails/'
;dir_irac1 = '/chooyu1/muzzin/SpARCS/Lockman/IRAC/thumbnails/'
...
read_LOCKMAN_zIRAC_finalcat, rra, rdec, apmag_176, eapmag_176, apmag_366, eapmag_366, mag_best, emag_best, c1_bf, c1_ebf, c1_3pxapc, c1_3pxerr, c2_bf, c2_ebf, c2_3pxapc, c2_3pxerr
...
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/Lockman/clusterpics/cluster'+string(cnum)+'.jpg', /remove_all), TVRD(true = 3), true = 3

;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/Lockman/clusterpics/cluster'+string(cnum)+'_wide.jpg', /remove_all), TVRD(true = 3), true = 3
