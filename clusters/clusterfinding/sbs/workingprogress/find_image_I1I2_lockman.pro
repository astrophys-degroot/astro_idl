...
nclust = numlines('/chooyu1/muzzin/SpARCS/Lockman/foundclusters_I1I2/final_I1I2_clustercat_combined.cat') -2

print, zimage

openr, lun, '/chooyu1/muzzin/SpARCS/Lockman/foundclusters_I1I2/final_I1I2_clustercat_combined.cat', /get_lun
header = strarr(2)
readf, lun, header
...
openw, lun, '/chooyu1/muzzin/SpARCS/Lockman/foundclusters_I1I2/final_LOCKMAN_fields.cat', /get_lun
printf, lun, header
