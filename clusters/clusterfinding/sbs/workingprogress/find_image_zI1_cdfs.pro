...
nclust = numlines('/chooyu1/muzzin/SpARCS/CDFS/foundclusters_z/final_z_clustercat_combined.cat') -2

openr, lun, '/chooyu1/muzzin/SpARCS/CDFS/foundclusters_z/final_z_clustercat_combined.cat', /get_lun
header = strarr(2)
readf, lun, header
...
openw, lun, '/chooyu1/muzzin/SpARCS/CDFS/foundclusters_z/final_CDFS_fields.cat', /get_lun
printf, lun, header
