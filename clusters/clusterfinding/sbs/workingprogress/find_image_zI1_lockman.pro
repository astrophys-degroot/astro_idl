...
readcol, '/chooyu1/muzzin/SpARCS/Lockman/zimage_positions.dat', zimage, rall, decll, raur, decur, format = '(a, d, d, d, d)', skipline = 2 
readcol, '/chooyu1/muzzin/SpARCS/Lockman/IRAC1image_positions.dat', IRAC1image, irall, idecll, iraur, idecur, format = '(a, d, d, d, d)', skipline = 2 

print, idecur

;Read in clusters

nclust = numlines('/chooyu1/muzzin/SpARCS/Lockman/foundclusters_z/final_z_clustercat_combined.cat') -2

print, zimage

openr, lun, '/chooyu1/muzzin/SpARCS/Lockman/foundclusters_z/final_z_clustercat_combined.cat', /get_lun
header = strarr(2)
readf, lun, header
...
image_files = ['/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_1_1_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_1_2_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_1_3_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_1_4_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_2_1_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_2_2_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_2_3_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_2_4_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_3_1_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_3_2_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_3_3_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_3_4_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_4_1_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_4_2_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_4_3_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_4_4_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_5_1_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_5_2_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_5_3_v2_mosaic.fits', $
'/chooyu1/muzzin/SpARCS/Lockman/IRAC/smallswire_Lockman_I1_tile_5_4_v2_mosaic.fits']
...
openw, lun, '/chooyu1/muzzin/SpARCS/Lockman/foundclusters_z/final_LOCKMAN_fields.cat', /get_lun
printf, lun, header
for x = 0, n_elements(kpno_field) - 1.0 do begin
printf, lun, format = '(f7.5, 1x, 2(a13, 2x), 5(f10.5, 1x), i3, 2x, a18, 3x, a40)',z[x], sra[x], sdec[x], xpos[x], ypos[x], ra[x], dec[x], flux[x], slicenum[x], kpno_field[x], irac1_field[x]
endfor
free_lun, lun
