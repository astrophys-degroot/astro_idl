...
openw, lun, '/chooyu1/muzzin/SpARCS/Lockman/foundclusters_I1I2/highz_sex_cluster_cat.cat', /get_lun
...
image_path = '/chooyu1/muzzin/SpARCS/Lockman/I1I2clustermaps/'
...
if (use_noise eq 'false') then image = Readfits(strcompress('/chooyu1/muzzin/SpARCS/Lockman/I1I2clustermaps/cmap_slice'+string(slicenum)+'.fits', /remove_all))
if (use_noise eq 'true') then image = Readfits(strcompress('/chooyu1/muzzin/SpARCS/Lockman/I1I2clustermaps/cmap_finalmap'+string(slicenum)+'.fits', /remove_all))

readcol, '/chooyu1/muzzin/SpARCS/Lockman/I1I2clustermaps/test.cat', cnum, flux_3px, flux_5px, eflux_3px, eflux_5px, flux_auto, eflux_auto,  $
