...
openw, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N2/foundclusters_z/highz_sex_cluster_cat.cat', /get_lun
...
image_path = '/chooyu1/muzzin/SpARCS/ELAIS-N2/zclustermaps/'
...
if (use_noise eq 'false') then image = Readfits(strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/zclustermaps/cmap_slice'+string(slicenum)+'.fits', /remove_all))
if (use_noise eq 'true') then image = Readfits(strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/zclustermaps/cmap_finalmap'+string(slicenum)+'.fits', /remove_all))

readcol, '/chooyu1/muzzin/SpARCS/ELAIS-N2/zclustermaps/test.cat', cnum, flux_3px, flux_5px, eflux_3px, eflux_5px, flux_auto, eflux_auto,  $
...
readweight_final_z_ELAISN2, ra, dec, zMI1, ezMI1, I1tot, eI1tot, mag_auto, emag_auto, weight, slicenum
