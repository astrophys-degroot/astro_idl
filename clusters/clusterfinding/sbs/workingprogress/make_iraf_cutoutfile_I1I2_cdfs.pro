...
catfile = '/chooyu1/muzzin/SpARCS/CDFS/foundclusters_I1I2/final_CDFS_fields.cat'
readcol, catfile, z, sra, sdec, xpos, ypos, ra, dec, flux, slicenum, kpno_field, irac1_field, $
format = 'd, a, a, d, d, d, d, d, i, a, a)', skipline = 2

openw, lun, '/chooyu1/muzzin/CTIO_data/CDFS_photometry/I1I2_zband_images_in.lst', /get_lun
openw, lun2, '/chooyu1/muzzin/SpARCS/CDFS/IRAC/I1I2_irac1_images_in.lst', /get_lun
openw, lun3, '/chooyu1/muzzin/CTIO_data/CDFS_photometry/I1I2_zband_images_out.lst', /get_lun
openw, lun4, '/chooyu1/muzzin/SpARCS/CDFS/IRAC/I1I2_irac1_images_out.lst', /get_lun
...
;junk_image = readfits(strcompress('/chooyu1/muzzin/SpARCS/CDFS/IRAC/'+irac1_field[x], /remove_all))
