...
catfile = '/chooyu1/muzzin/SpARCS/ELAIS-N2/foundclusters_I1I2/final_ELAISN2_fields.cat'
readcol, catfile, z, sra, sdec, xpos, ypos, ra, dec, flux, slicenum, kpno_field, irac1_field, $
format = 'd, a, a, d, d, d, d, d, i, a, a)', skipline = 2

openw, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N2/z/zband_images_in.lst', /get_lun
openw, lun2, '/chooyu1/muzzin/SpARCS/ELAIS-N2/IRAC/irac1_images_in.lst', /get_lun
openw, lun3, '/chooyu1/muzzin/SpARCS/ELAIS-N2/z/zband_images_out.lst', /get_lun
openw, lun4, '/chooyu1/muzzin/SpARCS/ELAIS-N2/IRAC/irac1_images_out.lst', /get_lun
...
zheader = headfits( strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/z/'+kpno_field[x], /remove_all))
...
irac1header = headfits( strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/IRAC/'+irac1_field[x], /remove_all))
angsz = angularsize(z[x], 1000.0)
...
if irac1xposur gt 5500 then irac1xposur = 5500
if irac1yposur gt 5500 then irac1yposur = 5500
