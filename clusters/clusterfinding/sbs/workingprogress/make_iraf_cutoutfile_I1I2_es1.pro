...
catfile = '/chooyu1/muzzin/SpARCS/ELAIS-S1/foundclusters_I1I2/final_ELAISS1_fields.cat'
readcol, catfile, z, sra, sdec, xpos, ypos, ra, dec, flux, slicenum, kpno_field, irac1_field, $
format = 'd, a, a, d, d, d, d, d, i, a, a)', skipline = 2

openw, lun, '/chooyu1/muzzin/CTIO_data/ELAIS-S1_photometry/I1I2_zband_images_in.lst', /get_lun
openw, lun2, '/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/I1I2_irac1_images_in.lst', /get_lun
openw, lun3, '/chooyu1/muzzin/CTIO_data/ELAIS-S1_photometry/I1I2_zband_images_out.lst', /get_lun
openw, lun4, '/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/I1I2_irac1_images_out.lst', /get_lun
...
zheader = headfits( strcompress('/chooyu1/muzzin/CTIO_data/ELAIS-S1_photometry/'+kpno_field[x], /remove_all))
;.r angularsize
...
irac1header = headfits( strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/'+irac1_field[x], /remove_all))
;junk_image = readfits(strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/'+irac1_field[x], /remove_all))
imsizex = 5050 ;n_elements(junk_image[*,0])
imsizey = 4950 ;n_elements(junk_image[0,*])
angsz = angularsize(z[x], 1000.0)
