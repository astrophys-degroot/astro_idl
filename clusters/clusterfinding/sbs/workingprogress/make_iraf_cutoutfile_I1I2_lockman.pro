...
catfile = '/chooyu1/muzzin/SpARCS/Lockman/foundclusters_I1I2/final_LOCKMAN_fields.cat'
readcol, catfile, z, sra, sdec, xpos, ypos, ra, dec, flux, slicenum, kpno_field, irac1_field, $
format = 'd, a, a, d, d, d, d, d, i, a, a)', skipline = 2

openw, lun, '/chooyu1/muzzin/SpARCS/Lockman/z/I1I2_zband_images_in.lst', /get_lun
openw, lun2, '/chooyu1/muzzin/SpARCS/Lockman/IRAC/I1I2_irac1_images_in.lst', /get_lun
openw, lun3, '/chooyu1/muzzin/SpARCS/Lockman/z/I1I2_zband_images_out.lst', /get_lun
openw, lun4, '/chooyu1/muzzin/SpARCS/Lockman/IRAC/I1I2_irac1_images_out.lst', /get_lun
...
imsizex = 4800 ;n_elements(junk_image[*,0])
imsizey = 5300 ;n_elements(junk_image[0,*])
angsz = angularsize(z[x], 1000.0)
