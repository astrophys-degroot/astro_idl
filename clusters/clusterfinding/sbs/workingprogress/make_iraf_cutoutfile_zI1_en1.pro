...
catfile = '/chooyu1/muzzin/SpARCS/ELAIS-N1/foundclusters_z/final_ELAISN1_fields.cat'
readcol, catfile, z, sra, sdec, xpos, ypos, ra, dec, flux, slicenum, kpno_field, irac1_field, $
format = 'd, a, a, d, d, d, d, d, i, a, a)', skipline = 2

openw, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N1/z/zband_images_in.lst', /get_lun
openw, lun2, '/chooyu1/muzzin/SpARCS/ELAIS-N1/IRAC/irac1_images_in.lst', /get_lun
openw, lun3, '/chooyu1/muzzin/SpARCS/ELAIS-N1/z/zband_images_out.lst', /get_lun
openw, lun4, '/chooyu1/muzzin/SpARCS/ELAIS-N1/IRAC/irac1_images_out.lst', /get_lun
...
imsizex = 5430 ;n_elements(junk_image[*,0])
