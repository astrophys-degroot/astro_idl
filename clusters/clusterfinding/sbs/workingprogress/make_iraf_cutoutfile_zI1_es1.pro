...
catfile = '/chooyu1/muzzin/SpARCS/ELAIS-S1/foundclusters_z/final_ELAISS1_fields.cat'
readcol, catfile, z, sra, sdec, xpos, ypos, ra, dec, flux, slicenum, kpno_field, irac1_field, $
format = 'd, a, a, d, d, d, d, d, i, a, a)', skipline = 2

openw, lun, '/chooyu1/muzzin/CTIO_data/ELAIS-S1_photometry/zband_images_in.lst', /get_lun
openw, lun2, '/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/irac1_images_in.lst', /get_lun
openw, lun3, '/chooyu1/muzzin/CTIO_data/ELAIS-S1_photometry/zband_images_out.lst', /get_lun
openw, lun4, '/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/irac1_images_out.lst', /get_lun
...
;irac1header = headfits( strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/IRAC/cluster175_I1.fits', /remove_all))
angsz = angularsize(z[x], 1000.0)
...
if irac1xposur gt 5050 then irac1xposur = 5050
if irac1yposur gt 4950 then irac1yposur = 4950
