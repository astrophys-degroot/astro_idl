...
catfile = '/chooyu1/muzzin/SpARCS/Lockman/foundclusters_z/final_LOCKMAN_fields.cat'
readcol, catfile, z, sra, sdec, xpos, ypos, ra, dec, flux, slicenum, kpno_field, irac1_field, $
format = 'd, a, a, d, d, d, d, d, i, a, a)', skipline = 2

openw, lun, '/chooyu1/muzzin/SpARCS/Lockman/z/zband_images_in.lst', /get_lun
openw, lun2, '/chooyu1/muzzin/SpARCS/Lockman/IRAC/irac1_images_in.lst', /get_lun
openw, lun3, '/chooyu1/muzzin/SpARCS/Lockman/z/zband_images_out.lst', /get_lun
openw, lun4, '/chooyu1/muzzin/SpARCS/Lockman/IRAC/irac1_images_out.lst', /get_lun

;===========USING the OTHER NOT NORMALLY USED CENTROID=================
xpos = ra
ypos = dec
...
zheader = headfits( strcompress('/chooyu1/muzzin/SpARCS/Lockman/z/'+kpno_field[x], /remove_all))
;.r angularsize
...
irac1header = headfits( strcompress('/chooyu1/muzzin/SpARCS/Lockman/IRAC/'+irac1_field[x], /remove_all))
;junk_image = readfits(strcompress('/chooyu1/muzzin/SpARCS/Lockman/IRAC/'+irac1_field[x], /remove_all))
imsizex = 12800 ;n_elements(junk_image[*,0])
imsizey = 12300 ;n_elements(junk_image[0,*])
angsz = angularsize(z[x], 1000.0)
