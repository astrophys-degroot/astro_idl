...
openr, lun, '/chooyu1/muzzin/SpARCS/Lockman/zsliceweightszf40/slicepmdata.dat', /get_lun
header = strarr(2)
readf, lun, header
...
openw, lun, '/chooyu1/muzzin/SpARCS/Lockman/zsliceweightszf40/slicepmdata.dat', /get_lun
printf, lun, header
