z pro makecat_zband_IRAC


;==============If this fails for ***** then use xemacs to fix=========================
...
for i = 0L, gal-1 do begin
   if i mod 100000 eq 0 then print, i/1000L, 'k  Read'
   readf, lun5, rdata, format = '(i8, 2(1x,f12.6), 6(1x, f6.3), 8(1x,f11.3), 7(1x,f6.3))' 
...
junk = where( (star gt 0.9) or (sat_flag gt 4 and c1_flag gt 4) or (c2_flag gt 4 and c1_flag gt 4) or $
(sat_flag gt 4 and c2_flag gt 4), complement = useful)
...
openw, lun, 'CDFS_finalzIRAC.cat', /get_lun
