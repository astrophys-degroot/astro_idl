pro makefinalmaps_ELAISN1_I1I2
...
readweight_final_I1I2_ELAISN1, ra, dec, I1MI2, eI1MI2, I2tot, eI2tot, I1tot, eI1tot, weight, slicenum
...
openr, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N1/I1I2sliceweightszf40/slicepmdata.dat', /get_lun
header = strarr(2)
readf, lun, header
...
bpm_fix = readfits(strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/zclustermaps/' + 'cmap_weightmap' + string(bpm_map_index) +'.fits', /remove_all))
...
tvscl, hind
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/I1I2clustermaps/' + 'cmap_slice' + string(slicenum) +'.fits', /remove_all), hind
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/zclustermaps/' + 'cmap_slice' + string(slicenum) +'.jpg', /remove_all), TVRD()
...
tvscl, outmap
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/I1I2clustermaps/' + 'cmap_weightmap' + string(slicenum) +'.fits', /remove_all), outmap
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/zclustermaps/' + 'cmap_weightmap' + string(slicenum) +'.jpg', /remove_all), TVRD()
