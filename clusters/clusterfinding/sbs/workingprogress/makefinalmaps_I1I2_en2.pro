pro makefinalmaps_ELAISN2_I1I2
...
readweight_final_I1I2_ELAISN2, ra, dec, I1MI2, eI1MI2, I2tot, eI2tot, I1tot, eI1tot, weight, slicenum
...
openr, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N2/I1I2sliceweightszf40/slicepmdata.dat', /get_lun
header = strarr(2)
readf, lun, header
...
bpm_fix = readfits(strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/zclustermaps/' + 'cmap_weightmap' + string(bpm_map_index) +'.fits', /remove_all))
...
tvscl, hind
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/I1I2clustermaps/' + 'cmap_slice' + string(slicenum) +'.fits', /remove_all), hind
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/zclustermaps/' + 'cmap_slice' + string(slicenum) +'.jpg', /remove_all), TVRD()

;if q eq startslice then window, 2, xsize = 1300, ysize = 700, title = 'Bad Pixel Mask'
window, 2, xsize = 1300, ysize = 700, title = 'Bad Pixel Mask'
tvscl, outmap
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/I1I2clustermaps/' + 'cmap_weightmap' + string(slicenum) +'.fits', /remove_all), outmap
;write_jpeg, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/zclustermaps/' + 'cmap_weightmap' + string(slicenum) +'.jpg', /remove_all), TVRD()
