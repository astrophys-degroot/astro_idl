pro makefinalmaps_ELAISS1_I1I2
...
openr, lun, '/chooyu1/muzzin/SpARCS/ELAIS-S1/I1I2sliceweightszf40/slicepmdata.dat', /get_lun
header = strarr(2)
readf, lun, header
...
bpm_fix = readfits(strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/zclustermaps/' + 'cmap_weightmap' + string(bpm_map_index) +'.fits', /remove_all))
...
tvscl, hind
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/I1I2clustermaps/' + 'cmap_slice' + string(slicenum) +'.fits', /remove_all), hind
...
tvscl, outmap
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/I1I2clustermaps/' + 'cmap_weightmap' + string(slicenum) +'.fits', /remove_all), outmap
