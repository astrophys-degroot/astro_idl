...
openr, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N1/zsliceweightszf40/slicepmdata.dat', /get_lun
header = strarr(2)
readf, lun, header
...
window, 2, xsize = 1300, ysize = 1100, title = 'Bad Pixel Mask, z ='+z[slicenum]
tvscl, outmap
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/zclustermaps/' + 'cmap_weightmap' + string(slicenum) +'.fits', /remove_all), outmap
...
window, 1, xsize = 1300, ysize = 1100, title = 'Density Map, z ='+z[slicenum]
tvscl, hind
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/zclustermaps/' + 'cmap_slice' + string(slicenum) +'.fits', /remove_all), hind
