...
openr, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N2/zsliceweightszf40/slicepmdata.dat', /get_lun
header = strarr(2)
readf, lun, header
...
tvscl, hind
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/zclustermaps/' + 'cmap_slice' + string(slicenum) +'.fits', /remove_all), hind
...
tvscl, outmap
writefits, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/zclustermaps/' + 'cmap_weightmap' + string(slicenum) +'.fits', /remove_all), outmap
