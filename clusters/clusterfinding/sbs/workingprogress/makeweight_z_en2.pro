...
read_ELAISN2_zIRAC_finalcat, rar, decr, apmag_176, eapmag_176, apmag_366, eapmag_366, mag_best, emag_best, ch1bf, c1ebap, c1_3pxapc, c1_3pxerr, ch2bf, c2ebap, c2_3pxapc, c2_3pxerr
...
openw, lun6, '/chooyu1/muzzin/SpARCS/ELAIS-N2/zsliceweightszf40/zsliceindexzf40.dat', /get_lun
...
for x = 0L, n_elements(rar)-1 do begin
	...
	val = (zMI1[x])
	siggie = ezMI1[x]
	openw, lun5, '/chooyu1/muzzin/SpARCS/ELAIS-N2/gval.tmp', /get_lun
...
openw, lun4, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N2/zsliceweightszf40/'+fname, /remove_all), /get_lun
