...
;the GAUSS_REDSEQUENCE function for integration===== make sure you change the working dir in that function
...
read_ELAISS1_zIRAC_finalcat, rar, decr, apmag_176, eapmag_176, apmag_366, eapmag_366, mag_best, emag_best, ch1bf, c1ebap, c1_3pxapc, c1_3pxerr, ch2bf, c2ebap, c2_3pxapc, c2_3pxerr
...
openw, lun6, '/chooyu1/muzzin/SpARCS/ELAIS-S1/zsliceweightszf40/zsliceindexzf40.dat', /get_lun
...
if q eq startslice then window, 0, xsize = 600, ysize = 600, title = 'Colour Slice'
...
for x = 0L, n_elements(rar)-1 do begin
	...
	val = (zMI1[x])
	siggie = ezMI1[x]
	openw, lun5, '/chooyu1/muzzin/SpARCS/ELAIS-S1/gval.tmp', /get_lun
	...
	siggie = ezMI1[x]
	;=====================================================================
	;=================Don't forget to change the directory in 'gauss_redsequence'==========
	openw, lun5, '/chooyu1/muzzin/SpARCS/ELAIS-S1/gval.tmp', /get_lun
	printf, lun5, val, siggie
	free_lun, lun5
	!EXCEPT = 0
...
openw, lun4, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/zsliceweightszf40/'+fname, /remove_all), /get_lun
tempra = [rar[0], rar[0:n_elements(rar)-1]]
writeu, lun4, tempra, decr, zMI1, ezMI1, I1tot, eI1tot, mag_best, emag_best, weight
free_lun, lun4
