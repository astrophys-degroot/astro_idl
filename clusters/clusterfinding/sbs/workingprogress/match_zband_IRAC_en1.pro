...
irac_cat = '/chooyu1/muzzin/SpARCS/ELAIS-N1/IRAC/I1_I2_matched_final.cat'
zband_cat = '/chooyu1/muzzin/SpARCS/ELAIS-N1/z/zband_all_nooverlap_final_ext.cat'
out_cat = '/chooyu1/muzzin/SpARCS/ELAIS-N1/IRAC/zband_I1I2_matched_final.cat'

rdata = dblarr(18)
;numlines('/chooyu1/muzzin/SpARCS/ELAIS-N1/z/zband_all_nooverlap_final_ext.cat')-1)

print, 'Reading z-band Catalogue file'
openr, lun, zband_cat, /get_lun

ngal_z = numlines('/chooyu1/muzzin/SpARCS/ELAIS-N1/z/zband_all_nooverlap_final_ext.cat')
;ngal_z = 15000
...
readf, lun, format = '(i8, 2(f14.8), 15(f12.4))', rdata
...
;==============================================================================
;==========THIS TRUNACATES THE IRAC CAT BECAUSE OF NO LOCKMAN COVERAGE  =======
;==============================================================================
...
;print, 'Number of ELAIS-N1 Gals pre-truncate:', n_elements(deci)

;IRAC_trunc = where(rai le rarmax and rai ge rarmin and deci le decmax and deci ge decmin)

;ch1id = ch1id[IRAC_trunc] & rai = rai[IRAC_trunc] & deci = deci[IRAC_trunc]
;ch1bf = ch1bf[IRAC_trunc] & c1ebap = c1ebap[IRAC_trunc] 
;c1_3pxapc = c1_3pxapc[IRAC_trunc] & c1_3pxerr = c1_3pxerr[IRAC_trunc]
;ch2bf = ch2bf[IRAC_trunc] & c2ebap = c2ebap[IRAC_trunc]
;c2_3pxapc = c2_3pxapc[IRAC_trunc] & c2_3pxerr = c2_3pxerr[IRAC_trunc]
;c1_flag = c1_flag[IRAC_trunc] & c1_class = c1_class[IRAC_trunc] 
;c2_flag = c2_flag[IRAC_trunc] & c2_class = c2_class[IRAC_trunc]

;print, "Number of ELAIS-N1 Gals post-truncate:', n_elements(deci)
...
format = '(i8, 2(1x,f14.6), 6(1x, f8.3), 8(1x,f13.3), 7(1x,f8.3))' 
...
openw, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N1/z/zband_nonmatch.cat', /get_lun
