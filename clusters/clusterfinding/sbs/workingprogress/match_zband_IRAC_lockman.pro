...
irac_cat = '/chooyu1/muzzin/SpARCS/Lockman/IRAC/I1_I2_matched_final.cat'
zband_cat = '/chooyu1/muzzin/SpARCS/Lockman/z/zband_all_nooverlap_final_ext.cat'
out_cat = '/chooyu1/muzzin/SpARCS/Lockman/IRAC/zband_I1I2_matched_final.cat'

rdata = dblarr(18)
;numlines('/chooyu1/muzzin/SpARCS/Lockman/z/zband_all_nooverlap_final_ext.cat')-1)

print, 'Reading z-band Catalogue file'
openr, lun, zband_cat, /get_lun

ngal_z = numlines('/chooyu1/muzzin/SpARCS/Lockman/z/zband_all_nooverlap_final_ext.cat')
;ngal_z = 15000
...
readf, lun, format = '(i8, 2(f14.8), 15(f11.4))', rdata
...
;print, 'Number of Lockman Gals pre-truncate:', n_elements(deci)
...
;print, "Number of Lockman Gals post-truncate:', n_elements(deci)
...
openw, lun, '/chooyu1/muzzin/SpARCS/Lockman/z/zband_nonmatch.cat', /get_lun
