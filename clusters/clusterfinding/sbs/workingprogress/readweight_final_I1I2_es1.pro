Pro readweight_final_I1I2_ELAISS1, rar, decr, zMI1, ezMI1, I1tot, eI1tot, mag_auto, emag_auto, weight, slicenum

print, 'ELAISN1: Using z 3" mags & IRAC 3 pixel mags'

galtot = 832121

filename = 'slice' + string(slicenum) + 'weights.dat'
openr, lun2, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/I1I2sliceweightszf40/' + filename, /remove_all), /get_lun
