Pro readweight_final_z_ELAISN1, rar, decr, zMI1, ezMI1, I1tot, eI1tot, mag_auto, emag_auto, weight, slicenum
...
openr, lun2, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-N1/zsliceweightszf40/' + filename, /remove_all), /get_lun
...
print, min(rar), max(rar), min(decr), max(decr)
return
end
