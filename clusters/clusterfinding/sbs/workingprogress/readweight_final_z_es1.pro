Pro readweight_final_z_ELAISS1, rar, decr, zMI1, ezMI1, I1tot, eI1tot, mag_auto, emag_auto, weight, slicenum

print, 'ELAIS-S1: Using z 3" mags & IRAC 3 pixel mags'

galtot = 302634
;galtot = 154249

filename = 'slice' + string(slicenum) + 'weights.dat'
openr, lun2, strcompress('/chooyu1/muzzin/SpARCS/ELAIS-S1/zsliceweightszf40/' + filename, /remove_all), /get_lun
