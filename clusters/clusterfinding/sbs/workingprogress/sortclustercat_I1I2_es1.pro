...
nclust = numlines('/chooyu1/muzzin/SpARCS/ELAIS-S1/foundclusters_I1I2/I1I2clustercat_combined.cat') -2

openr, lun, '/chooyu1/muzzin/SpARCS/ELAIS-S1/foundclusters_I1I2/I1I2clustercat_combined.cat', /get_lun
header = strarr(2)
readf, lun, header
...
;Open the logfile
openw, lun5, '/chooyu1/muzzin/SpARCS/ELAIS-S1/foundclusters_I1I2/catmerge.log', /get_lun
clustersremain = 'true'
debug = 0
...
openw, lun, '/chooyu1/muzzin/SpARCS/ELAIS-S1/foundclusters_I1I2/final_I1I2_clustercat_combined.cat', /get_lun
printf, lun, header
