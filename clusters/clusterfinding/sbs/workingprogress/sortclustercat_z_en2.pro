...
nclust = numlines('/chooyu1/muzzin/SpARCS/ELAIS-N2/foundclusters_z/zclustercat_combined.cat') -2

openr, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N2/foundclusters_z/zclustercat_combined.cat', /get_lun
header = strarr(2)
readf, lun, header
...
;Open the logfile
openw, lun5, '/chooyu1/muzzin/SpARCS/ELAIS-N2/foundclusters_z/catmerge.log', /get_lun
clustersremain = 'true'
debug = 0
...
openw, lun, '/chooyu1/muzzin/SpARCS/ELAIS-N2/foundclusters_z/final_z_clustercat_combined.cat', /get_lun
printf, lun, header
