pro readcolext,name,v1,V2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15, $
               ...
               v116,v117,v118,v119,v120,v121,v122,v123,v124,v125, COMMENT = comment, $
...
;
; CALLING SEQUENCE:
;       READCOL, name, v1, [ v2, v3, v4, v5, ...  v125 , COMMENT=, /NAN
...
;
; OUTPUTS:
;       V1,V2,V3,...V125 - IDL vectors to contain columns of data.
;               Up to 125 columns may be read.  The type of the output vectors
...
;       Increased the number of columns that may be handled A. DeGroot April 2013
;-
  ...
  if N_params() lt 2 then begin
     print,'Syntax - READCOL, name, v1, [ v2, v3,...v125, /NAN'
