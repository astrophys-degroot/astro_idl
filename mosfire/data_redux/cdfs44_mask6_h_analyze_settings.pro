...
FUNCTION cdfs44_mask6_H_analyze_settings, xwhich
  ...
  CASE xwhich OF
     ...
     'pzhi68' :  spectrum = {which:'pzhi68', basename:'cdfs44_mask6_v2_H', fitto:['Ha','NIIr','NIIb'], $
                             ...
                             initgss:['redshift=1.674', 'sig=3.5', 'c1=0.3', 'c2=0.2', 'c3=0.2', 'x0=0.1', 'x1=0.0001' ], $
                             priors:['REDSHIFT GT 1.669', 'REDSHIFT LT 1.679', 'SIG1 GT 0.0', 'C1 GT 0.0', 'C2 GT 0.0', 'C3 GT 0.0'], NEWVER:'v1-2'}
