...
;========================================================================================================================
pro cdfs44_mask1_H_measure, LIST=list, MASK=mask, OUTFILE=outfile, NAMEPOS=namepos, $
                            SGNFCUT=SGNFCUT, $
  ...
  IF keyword_set(LIST) THEN list = list[0] ELSE list = 'cdfs44_mask1_1.0_H_1dspeclist_v1-2.txt'
  IF keyword_set(LISTDIR) THEN listdir = listdir[0] ELSE $
     listdir = '/Users/degroota/research/current4_mosfire_2012nov28_cdfs44/CDFS44_mask1_1.0/'
  IF keyword_set(MASK) THEN mask = mask[0] ELSE mask = 'CDFS44_mask1_1.0_orig.coords'
  IF keyword_set(MASKDIR) THEN maskdir = maskdir[0] ELSE $
     maskdir = '/Users/degroota/research/observing/keck/mosfire/2012nov24/cdfs44/CDFS44_mask1_1.0/'
  IF keyword_set(NAMEPOS) THEN namepos = namepos[0] ELSE namepos = 5
  IF keyword_set(OUTFILE) THEN outfile = outfile[0] ELSE outfile = 'cdfs44_mask1_1dspeccat_v1-0.fits'
