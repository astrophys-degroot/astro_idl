;========================================================================================================================
pro mosfire_make_magmacat_xmm113_20151018, $
  ...
  datain = '/Users/adegroot/research/clusters/xmm/xmm113/catalogs/xmm113_pz_specz_full_v3-1-3.fits'
  starsin = '/Users/adegroot/research/clusters/xmm/xmm113/catalogs/stars/xmm113_2mass_JHK_8arcmin_v1-1.fits'
  magmaout = 'xmm113_feedtomagma_formask10_v1-1.txt'
  ...
  cra = 36.11465                 ;center RA   
  cdec = -3.395832               ;center Dec
  distance = [2.0,7.0,11.0,30.0] ;distance divisions [arcmin]
  
  specz = [0.0,1.616, 1.656, 3.0]  
  qspecz = [-2,-1,0,1,2,3]  
  ...
  subsets = [ $
            {name:'clhq', priority:50000L, sets:[6,10,10,10]}, $     ;
            {name:'clmq', priority:46000L, sets:[6,11,11,11]}, $     ;
            {name:'cllq', priority:43000L, sets:[6,12,12,12]}, $     ;
            {name:'qclpz', priority:10L, sets:[1,8,14,14]}, $        ;
            {name:'qchpzco', priority:500L, sets:[1,8,15,15]}, $     ;
            {name:'qnlpz', priority:9L, sets:[2,8,14,14]}, $         ;Quiescent Near Low Photo-Z
            {name:'qnhpzco', priority:500L, sets:[2,8,15,15]}, $     ;Quiescent Near High Photo-Z COntinuum
            {name:'targ', priority:5L, sets:[9,9,9,9]}, $            ;already targeted
            {name:'qnhpzhi', priority:9000L, sets:[1,15,20,20]}, $   ;Quiescent Near High Photo-Z High In 
            {name:'qnhpzmi', priority:8000L, sets:[1,15,19,19]}, $   ;Quiescent Near High Photo-Z Medium In 
            {name:'qchpzhi', priority:4000L, sets:[2,15,20,20]}, $   ;Quiescent Close High Photo-Z High In
            {name:'qchpzmils', priority:3000L, sets:[2,15,19,19]}, $ ;Quiescent Close High Photo-Z Medium In
            {name:'rest', priority:6L, sets:[4,4,4,4]} $             ;
...
;========================================================================================================================
pro remakecomp_xmm113_20151018, VERBOSE=verbose, HELP=help


  mascat = 'xmm113_feedtomagma_formask6_v1-0.txt' 
  directory = ' '
...
;========================================================================================================================
pro nextmask_xmm113_20151018, VERBOSE=verbose, HELP=help
  ...
  mascat = 'xmm113_feedtomagma_formask4_v2-1.txt'       ;master input list
  recmask = '../XMM113_mask4_v1/XMM113_mask4_v1.coords' ;just made mask
  compcat = 'xmm113_feedtomagma_formask4_v2-1.fits'     ;companion list
  outfile = 'xmm113_feedtomagma_formask5_v2-1txt'      ;next input file
  outcompnext = 'xmm113_feedtomagma_formask5_v2-1.fits' ;companion to next input file
  outcompthis = 'xmm113_feedtomagma_inmask4_v2-1.fits'  ;mask you just created
