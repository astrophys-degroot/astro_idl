...
PRO wuyts2016::boxscore
  ...
  self.wu16N2data_z23 = ptr_new({xsmod:[10.03, 10.27, 10.43, 10.59, 10.83], $                      ;
                                 xserrmodn:[0.23,0.12,0.13,0.08,0.08,0.12], $                      ;
                                 xserrmodp:[0.12,0.13,0.08,0.08,0.12,0.60], $                      ;
                                 xserrmod:[0.17,0.12,0.11,0.08,0.10,0.35], $                       ;
...
PRO wuyts2016__define
  ...
  void = {wuyts2016, wu16objver:'A', $
          wu16sampsize:0, wu16zmin:0.0, wu16zmax:0.0, $
