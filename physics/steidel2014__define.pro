...
PRO steidel2014::boxscore
  ...
  ;self.st14N2data = ptr_new({xs:[], $                                                ; 
  ;                           xsmod:[8.87,9.34,9.69,9.87,10.11,10.37,10.66,11.19], $  ;
  ;                           xserr:[], $                                             ;
  ;                           xserrmodn:[0.27], $                                     ;
  ;                           xserrmodp:[0.13], $                                     ;
  ;                           ys:[], $                                                ;
...
PRO steidel2014__define
  ...
  void = {steidel2014, st14objver:'A', $
          ...
          st14IMF:'A', st14mzrtype:'A', st14selection:'A', st14N2data:ptr_new(), st14mzrdata:ptr_new()}
